...
<div id="form1">
<form class="form-horizontal" name="form1" role="form"action = "" method = "POST">
  
	  <div class="form-group">
    <label for="inputEmail3" class="col-sm-2 control-label"> 负责人：</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" id="inputEmail3" placeholder="负责人名字"name="name">
    </div>
  </div><br>
<div class="form-group">
    <label for="inputEmail3" class="col-sm-2 control-label"> 使用日期:</label>
    <div class="col-sm-10">
      <div class="row">
        <div class="col-md-4">
  ...
  <div class="form-group">
    <label for="inputEmail3" class="col-sm-2 control-label">使用时间段: </label>
    <div class="col-sm-10">
      <input type="textarea" class="form-control" id="inputEmail3" placeholder="上午/下午/晚上"name="time">
    </div>
  </div><br>
  <div class="form-group">
