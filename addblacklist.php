...
<div id="inner">
<div id="form1">
 <form action="php/add_blacklist.php"  name="form1"  method="POST" id="form1" >
  <br><br><br><br><br><br>
  ...
  <button id="bu"type="submit" class="btn btn-default">确认</button>&nbsp;&nbsp;
</form>
<a href="blacklist.php" class="btn btn-default">取消</a>


  <script type="text/javascript" src="public/js/jquery-1.11.0.min.js"></script>
    <script type="text/javascript" src="public/js/bootstrap.min.js"></script>
    <script type="text/javascript" src="public/js/jquery-ui.js"></script>
<script type="text/javascript"  src="js/addblacklist.js"></script>
